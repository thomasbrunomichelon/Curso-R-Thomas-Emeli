...
-   Esta função associa a cada nú mero real a probabilidade de que a variável tome valores menores ou iguais a este número
...
-   q*distribu* (x, par) com a qual podemos calcular o p-cuantil da distribuição *distribu*. Isto é, (1/F)(p), sendo F a função de distribuição de *distribu*.
...
 \
- qnorm (p, a, b) \# cuantil de ordem p da normal (a, b) 

\
- rnorm (n, a, b) \# amostra aleatoria de tamanho n da normal (a, b)
...
a)  A probabilidade de que uma pessoa, selecionada ao acaso deste grupo, seja menor que 160 cm.
    ...
    ![](figuras/graficos%20normal1.png){width="614"}
...
![](figuras/grafico%20normal3.png){width="413"}
...
![](figuras/grafico%20normal4.png){width="468"}
...
Se você toma amostras repetidas de uma população com variancia finita e calcula suas médias, então as médias serão normalmente distribuidas.
...
qchisq (p, n) \# cuantil de ordem p da Chi-quadrado com n grados de liberdade.\
...
qt (x, n) \# cuantil de ordem p da t-Student com n graus de liberdade\
...
A figura gerada estava representando a densidade da t de Student com n = 5, 8, 15 e 30 graus de liberdade e sobrepondo em cada caso, a densidade da normal estándar.
...
-   qf (p, n1, n2) \# cuantil de ordem p da F (n1, n2)\
...
\
- qbinom (q, n, p) \# cuantil de ordem q da binomial (n, p)

\
- rbinom (m, n, p) \# muestra aleatória de tamanho m da binomial (n, p)
...
\
- qpois (x, a) \# cuantil de ordem p da Poisson (a)
...
-   qnbinom (q, n, p) \# cuantil de ordem q da binomial negativa (n, p)
...
-   Suporte ao minitab [minitab 18] (<https://support.minitab.com/pt-br/minitab/18/help-and-how-to/probability-distributions-and-random-data/supporting-topics/distributions/poisson-distribution/>)
