...
![](images/Diretorio-5.png){width="359"}
...
-   **Cuidado**, alguns símbolos podem mudar sua função quando dentro de uma **fórmula**. Por exemplo, o simbolo aritimético de multiplicação ($*$) em uma fórmula representa interação entre dois efeitos, já o que cria uma sequência ($:$), significa a soma dos efeitos simples mais a interação.
